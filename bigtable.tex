...
\ \\ \hline
  ...
  \textbf{Loop freedom}
&
  \multicolumn{2}{>{\columncolor[gray]{0.8}}c|}{Impossible (Lemma \ref{lemma:imp loop-free})}
&
...
&
  \multicolumn{3}{>{\columncolor[gray]{0.8}}c|}{Impossible (Lemma \ref{lemma:imp packet coherence})}
&
...
&
  \multicolumn{4}{>{\columncolor[gray]{0.8}}c|}{Impossible (Lemma \ref{lemma:imp bandwidth limit})}
&
