...
We can capture such dependencies by broadening from dependency forests to {\em dependency graphs}. We will return to dependency graphs in Section~\ref{sec:discussion}, after getting a better understanding of the consistency space.

TODO: the remainder of this should probably go to Section 5.
